...
int main(int argc, char** argv) {
   ...
   print_matrix (user_ratings_working_dataset, N_users, N_movies, "users00");
   print_matrix (client_ratings_working_dataset, N_users, N_movies, "client00"); 
   std::cout << "N_users " << N_users << " N_movies " << N_movies << "\n";
   ...
   print_matrix (user_ratings_working_dataset, N_users, N_movies, "users0");
   print_matrix (client_ratings_working_dataset, N_users, N_movies, "client0");
    ...
    */
    ...
    print_matrix (user_ratings_working_dataset, N_users, N_movies, "users1");
    print_matrix (client_ratings_working_dataset, N_users, N_movies, "client1");
